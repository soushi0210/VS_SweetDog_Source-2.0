    ...
    if lol ~= opponentStyle then
        for o = 0,3 do
            if opponentStyle == 'Up' then
                noteTweenAlpha('NoteGoAlpha'..o, 1 ,0.1,'linear')
            ...
            elseif opponentStyle == 'Right' then
                noteTweenAlpha('NoteGoAlpha'..o, 1 ,0.1,'linear')
                if playerStyle == 'Left' then
                    noteTweenAlpha('NoteGoAlpha'..o, 0.5 ,0.1,'linear')
                end
...
function onTimerCompleted(tag)
    if tag == 'changeOpponentNotesTo'..opponentStyle then
        ...
        elseif opponentStyle == 'Default' or opponentStyle == '' or opponentStyle ~= '' and opponentStyle ~= '' and opponentStyle ~= 'Up' and opponentStyle ~= 'Down' and opponentStyle ~= 'Left' and opponentStyle ~= 'Right' then
            backOffset(nil,nil,false)
            backAlpha(false,true,true)
        ...
        for ResetOpponentNotes = 0,3 do
            ...
            if backY == true then
                if downscroll == false then
                    noteTweenY('NoteGoDefaultOpponentY'..ResetOpponentNotes,ResetOpponentNotes,50,0.2, 'linear')
                else
                    noteTweenY('NoteGoDefaultOpponentY'..ResetOpponentNotes, ResetOpponentNotes,screenHeight - 150,0.2, 'linear')
                end
            end
